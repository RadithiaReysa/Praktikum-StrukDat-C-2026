...
linked.tambah_kendaraan("B 1111 AA")
linked.tambah_kendaraan("D 2222 BB")
linked.tambah_kendaraan("A 3333 CC")
linked.tambah_kendaraan("B 4444 DD")
print("Sebelum:")
linked.tampilkan_maju()
print()
linked.hapus_kendaraan("A 3333 CC")
print()
print("Sesudah:")
linked.tampilkan_maju()